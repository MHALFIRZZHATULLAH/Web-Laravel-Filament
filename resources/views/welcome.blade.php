...
<body id="page-top">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-4 mb-5 mb-lg-0">
          ...
          @endif
          @if ($x)
            <a class="btn btn-outline-light btn-social mx-1" href="{{ $x }}"><i class="fab fa-fw fa-twitter"></i></a>
          @endif
          @if ($facebook)
        ...
        <div class="col-lg-4">
          ...
          <p class="lead mb-0">{!! strip_tags($site_description) !!}</p>
        </div>
      </div>
    </div>
  </footer>
  ...
  <div class="copyright py-4 text-center text-white">
    <div class="container"><small>Copyright &copy; <b>{{ $site_name }}</b> 2020-{{ date("Y") }}</small></div>
  </div>
  <!-- Partner Modals-->
  @foreach ($partner as $index => $item)
    <!-- Partner Modal {{ $index + 1 }}-->
            ...
            <div class="container">
              <div class="row justify-content-center">
                <div class="col-lg-8">
                  ...
                  <!-- Partner Modal - Text-->
                  {!! $item->content !!}
                  <a href="{{ $item->link }}" class="btn btn-primary">{{ $item->link }}</a>
                </div>
              </div>
            </div>
          </div>
